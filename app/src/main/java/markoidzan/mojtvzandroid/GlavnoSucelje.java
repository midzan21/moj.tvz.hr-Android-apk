...
public class GlavnoSucelje extends ActionBarActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            AlertDialog.Builder oAplikaciji = new AlertDialog.Builder(this);
            oAplikaciji.setTitle(R.string.action_about_dialog);
            oAplikaciji.setMessage(R.string.text_about_dialog);
            oAplikaciji.setPositiveButton(R.string.text_action_close_about_dialog, new DialogInterface.OnClickListener() {
                @Override
